...
getgenv().gagConfig = {
	...
	PLACE_COSMETIC = { "Kitchen Cart", "Smoothie Fountain", "Kitchen Flooring", "Cooking Cauldron", "Kitchen Crate", "Gourmet Seed Pack" }
