...
getgenv().gagConfig = {
    ...
    EQUIP_PETS = { ["Sunny-Side Chicken"] = 8 },
    ...
    PET_WEBHOOK_URL = "https://discord.com/api/webhooks/1406338505386364959/gzpb2xUW3sVm8pKQpH205p8igYFDUO-YOmHdqHvtOhyGZBC1nNx3xp-elUFE8WfgdGuV",
    SEED_WEBHOOK_URL = "", 
    NOTIFY_PETS = { "Golden Goose", "Kitsune" },
